...
const deCatalog: TranslationCatalog = {
  ...
  ankiImport: {
    ...
    settingsDescription: "Erstellt Karten aus einem Anki-Deck-Paket. Beliebige Notiztypen (inkl. benutzerdefiniert und Cloze) auf Vorder- und Rückseite zuordnen.",
    ...
    success: "{{imported}} Karten in Deck „{{deck}}“ importiert. Leer übersprungen: {{skippedEmpty}}. Nicht zugeordnet: {{skippedUnmapped}}. Cloze in Datei: {{cloze}}.",
    ...
    previewSourceLabel: "Datei",
    previewNotesLabel: "Notizen",
    previewModelsLabel: "Notiztypen",
    mappingHint: "Wähle für jeden Notiztyp die Felder für Vorder- und Rückseite. Die Auswahl wird für den nächsten Import gespeichert.",
    clozeLabel: "Cloze",
    modelNoteCount: "{{count}} Notizen",
    frontFieldsLabel: "Vorderseitenfelder",
    backFieldsLabel: "Rückseitenfelder",
    previewSampleLabel: "Beispielkarte",
    previewFrontLabel: "Vorderseite",
    previewBackLabel: "Rückseite",
    previewEmpty: "(leer)",
    frontRequired: "Mindestens ein Vorderseitenfeld wählen.",
    confirmImport: "Mit dieser Zuordnung importieren",
    cancelMapping: "Abbrechen",
  },
  localBackup: {
    ...
    saveAction: "Backup-Datei speichern",
    dismissAction: "Später",
    saved: "Download der Backup-Datei gestartet.",
    shareOpened: "Teilen-Sheet geöffnet. Wähle Dateien, um das Backup zu behalten.",
    saveFailed: "Backup-Datei konnte nicht gespeichert werden.",
    settingsTitle: "Backup als Datei",
    settingsDescription: "Exportiere Karten, Decks und Review-Verlauf als JSON-Datei auf diesem Gerät.",
    settingsValue: "Speichern",
    lastSavedNever: "Noch kein Datei-Backup",
