...
const esEsCatalog: TranslationCatalog = {
  ...
  loading: {
    ...
    importSettings: "Cargando los ajustes de importación...",
    exportSettings: "Cargando los ajustes de exportación...",
  ...
  progressScreen: {
    ...
    leaderboard: {
      title: "Clasificación por valoraciones",
      loading: "Cargando la clasificación por valoraciones...",
      infoToggleLabel: "Acerca de la clasificación por valoraciones",
      info: "Los repasos valorados como Difícil, Bien o Fácil cuentan para tu puesto. Los repasos con Otra vez no cuentan.",
      periodsLabel: "Periodo de la clasificación por valoraciones",
      periods: {
        last24Hours: "24 h",
        last3Days: "3 d",
        last7Days: "7 d",
      ...
      you: "Tú",
      rankLabel: "n.º {{rank}}",
      updatedAt: "Actualizado hace {{duration}}",
      updatedAtDuration: {
        hoursAndMinutes: "{{hours}} y {{minutes}}",
        hours: {
          zero: "{{count}} horas",
          one: "{{count}} hora",
          two: "{{count}} horas",
      ...
      guestBody: "Inicia sesión para ver cómo se sitúan tus valoraciones de repaso frente a otros estudiantes.",
      ...
      invite: {
        ...
        creating: "Creando...",
        readyBody: "Envía este enlace a tu amigo. Podrá abrirlo, iniciar sesión o registrarse, y os veréis en la app. Caduca el {{expiresAt}}.",
        ...
        shareText: "Abre esta invitación de Flashcards, inicia sesión o regístrate, y nos veremos en la app.",
        ...
        validation: {
          required: "Introduce un nombre de amigo.",
      ...
      profile: {
        ...
        bestRatingPlacement: "n.º {{rank}} en {{period}}",
        notRanked: "Sin puesto",
        activityTitle: "Actividad de 30 días",
        activityChartLabel: "Actividad diaria de repasos de los últimos 30 días",
        activityDayLabel: "{{date}}: {{count}} repasos",
        joinedAt: "Se unió",
        totalCards: "Tarjetas totales",
        linkedAccountRequired: "Inicia sesión para ver perfiles de la clasificación.",
        participationDisabled: "Este perfil está oculto mientras la participación en la clasificación está desactivada.",
        unavailable: "Este perfil de la clasificación no está disponible ahora mismo.",
        errorBody: "No se pudo cargar este perfil. Comprueba tu conexión e inténtalo de nuevo.",
      },
    },
    streakLeaderboard: {
      title: "Clasificación por racha",
      loading: "Cargando la clasificación por racha...",
      infoToggleLabel: "Acerca de la clasificación por racha",
      info: "Los días de tu racha actual determinan tu puesto. Un día de racha es cualquier día local con al menos un repaso de tarjeta valorado como Otra vez, Difícil, Bien o Fácil. Cuando la instantánea pública aún no está disponible, se muestra tu racha actual local.",
      updatedAt: "Actualizado hace {{duration}}",
      guestBody: "Inicia sesión para comparar tu racha actual con otros estudiantes.",
      participationDisabledBody: "Los puestos de racha están ocultos mientras la participación en la clasificación está desactivada. Actívala de nuevo para ver a otros estudiantes y tu puesto.",
      offlineEmpty: "La clasificación por racha no está disponible sin conexión. Conéctate para ver los puestos.",
      unavailable: "La clasificación por racha no está disponible ahora mismo. Vuelve más tarde.",
      dayLabels: {
        one: "día",
        other: "días",
      },
  ...
  friendInvite: {
    ...
    signInTitle: "Únete a Flashcards con esta invitación",
    signInBody: "Flashcards es una app de estudio para recordar con tarjetas. Esta invitación te conecta con la persona que la envió, para que podáis veros en estadísticas como las clasificaciones. Continúa con tu correo para usar la app y conectaros.",
    signInButton: "Iniciar sesión / Registrarse",
    formTitle: "Elige el nombre de este amigo",
    formBody: "Este nombre privado es solo para tu app. La persona que envió el enlace no lo verá ni lo elegirá.",
    displayNameLabel: "Nombre privado para la persona que envió este enlace",
    displayNamePlaceholder: "Alex",
    accept: "Aceptar invitación",
    accepting: "Aceptando...",
    successTitle: "Ahora sois amigos",
    successBody: "Ahora sois amigos en Flashcards. Por ahora podéis encontraros en la clasificación.",
  ...
  settingsHome: {
    ...
    server: {
      title: "Servidor",
      description: "El cliente del navegador usa el despliegue web alojado. El cambio de servidor personalizado no está disponible en los ajustes web.",
      value: "Alojado",
    },
  ...
  ankiImport: {
    ...
    settingsDescription: "Crea tarjetas desde un paquete de mazo de Anki. Asigna campos de cualquier tipo de nota (incluidos personalizados y cloze) al anverso y reverso.",
    settingsValue: "Elegir archivo",
    parsing: "Leyendo .apkg…",
    importing: "Importando {{count}} notas…",
    progress: "Importadas {{imported}} / {{total}}",
    success: "Se importaron {{imported}} tarjetas al mazo “{{deck}}”. Vacías omitidas: {{skippedEmpty}}. Sin asignar: {{skippedUnmapped}}. Cloze en el archivo: {{cloze}}.",
    ...
    previewSourceLabel: "Archivo",
    previewNotesLabel: "Notas",
    previewModelsLabel: "Tipos de nota",
    mappingHint: "Elige qué campos serán el anverso y el reverso de cada tipo de nota. La selección se recuerda para el próximo import.",
    clozeLabel: "Cloze",
    modelNoteCount: "{{count}} notas",
    frontFieldsLabel: "Campos del anverso",
    backFieldsLabel: "Campos del reverso",
    previewSampleLabel: "Tarjeta de ejemplo",
    previewFrontLabel: "Anverso",
    previewBackLabel: "Reverso",
    previewEmpty: "(vacío)",
    frontRequired: "Selecciona al menos un campo del anverso.",
    confirmImport: "Importar con esta asignación",
    cancelMapping: "Cancelar",
  },
  localBackup: {
    ...
    saveAction: "Guardar copia",
    dismissAction: "Más tarde",
    saved: "Se inició la descarga de la copia de seguridad.",
    shareOpened: "Se abrió el menú de compartir. Elige Archivos para guardar la copia.",
    saveFailed: "No se pudo guardar la copia de seguridad.",
    settingsTitle: "Copia en archivo",
    settingsDescription: "Exporta tarjetas, mazos e historial de repaso como JSON en este dispositivo.",
    settingsValue: "Guardar",
    lastSavedNever: "Aún no hay copia en archivo",
    lastSavedPrefix: "Última guardada",
  },
  settingsTest: {
    title: "Prueba",
    ...
    localSyncDiagnostics: {
      title: "Diagnóstico de sincronización local",
      description: "Inspecciona el estado local de sincronización de tarjetas y medios en IndexedDB.",
      value: "Solo lectura",
      screenTitle: "Diagnóstico de sincronización local",
      screenSubtitle: "Estado local de sincronización de solo lectura para este navegador.",
      refresh: "Actualizar",
      ...
      generatedAt: "Generado: {{value}}",
      noWorkspace: "No hay ningún espacio de trabajo activo disponible.",
      unavailable: "-",
      sections: {
        cardsSync: "Sincronización de tarjetas",
        managedMediaSync: "Sincronización de medios gestionados",
        problemRecords: "Registros con problemas",
      },
      fields: {
        workspaceId: "ID de espacio de trabajo",
        installationId: "ID de instalación",
        cloudState: "Estado en la nube",
        localActiveCards: "Tarjetas activas locales",
        localDeletedCards: "Tarjetas eliminadas locales",
        pendingCardOperations: "Operaciones de tarjeta pendientes",
        failedCardOperations: "Operaciones de tarjeta fallidas",
        oldestPendingCardOperation: "Operación de tarjeta pendiente más antigua",
        latestCardSyncSuccess: "Última sincronización correcta de tarjetas",
        hotStateHydrated: "Estado caliente hidratado",
        hotCursor: "Cursor caliente",
        reviewCursor: "Cursor de repasos",
        latestSyncError: "Último error de sincronización",
        localActiveMediaAssets: "Medios activos locales",
        deletedMediaAssets: "Medios eliminados",
        localMediaBlobs: "Blobs de medios locales",
        localMediaBytes: "Bytes de medios locales",
        referencedMediaInCards: "Medios referenciados en tarjetas",
        referencesMissingLocalAsset: "Referencias sin medio local",
        assetsMissingLocalBlob: "Medios sin blob local",
        pendingMediaUploads: "Subidas de medios pendientes",
        failedMediaUploads: "Subidas de medios fallidas",
        pendingMediaDownloads: "Descargas de medios pendientes",
        failedMediaDownloads: "Descargas de medios fallidas",
        oldestPendingMediaTransfer: "Transferencia de medios pendiente más antigua",
        latestMediaUploadSuccess: "Última subida de medios correcta",
        latestMediaDownloadCacheSuccess: "Última descarga/caché de medios correcta",
        latestMediaTransferError: "Último error de transferencia de medios",
      },
      problem: {
        failedCardOutboxOperations: "Operaciones de tarjetas fallidas en outbox",
        failedMediaTransfers: "Transferencias de medios fallidas",
        missingMediaReferences: "Referencias de medios faltantes",
        assetsMissingLocalBlob: "Medios sin blob local",
        empty: "Ninguno",
        cardId: "ID de tarjeta",
        mediaAssetId: "ID de medio",
        kind: "Tipo",
  ...
  settingsWorkspace: {
    ...
    import: {
      title: "Importar",
      description: "Añade tarjetas desde un paquete portátil flashcards.zip.",
      value: "flashcards.zip",
    },
    resetProgress: {
  ...
  workspaceOverview: {
    ...
    delete: {
      ...
      lastWorkspaceHint: "Se creará inmediatamente un nuevo espacio Personal vacío después de la eliminación.",
  ...
  workspaceScheduler: {
    ...
    note: "Estos ajustes solo afectan a la programación futura. El estado actual de las tarjetas sigue siendo la referencia.",
  },
  workspaceExport: {
    title: "Exportar",
    subtitle: "Descarga un paquete portátil para este espacio de trabajo.",
    workspaceUnavailable: "El espacio de trabajo no está disponible",
    packageTitle: "flashcards.zip",
    packageDescription: "Previsualiza tarjetas activas, metadatos, etiquetas y multimedia referenciada antes de descargar.",
    packageExportSuccess: "La descarga de flashcards.zip ha comenzado.",
    packageExporting: "Descargando...",
    packagePreviewing: "Previsualizando...",
    packageExportPreviewButton: "Previsualizar exportación",
    packageExportConfirmButton: "Descargar flashcards.zip",
    packageExportPreviewRequired: "Previsualiza esta exportación antes de descargarla.",
    previewCardsLabel: "Tarjetas",
    previewReferencedMediaLabel: "Multimedia referenciada",
    previewMetadataLabel: "Etiqueta",
    previewMetadataAuthor: "Autor",
    previewMetadataComment: "Comentario",
    previewMetadataCreatedAt: "Creado",
    previewMetadataSourceUrl: "Fuente",
    exportPreviewReferencedMediaBytesLabel: "Tamaño multimedia",
    cardSelectionTitle: "Tarjetas a exportar",
    cardSelectionDescription: "Elige todas las tarjetas o selecciona tarjetas por etiqueta.",
    cardSelectionAllCardsLabel: "Todas las tarjetas",
    cardSelectionTagLabel: "Tarjetas con {{tag}} ({{count}} tarjetas)",
    includedTagsTitle: "Etiquetas incluidas en el paquete",
    includedTagsDescription: "Estas etiquetas se mantienen en las tarjetas exportadas. Las etiquetas de importación se omiten automáticamente.",
    includedTagLabel: "Incluir {{tag}} ({{count}} tarjetas)",
  },
  workspaceImport: {
    title: "Importar",
    ...
    importTagDescription: "Añade una etiqueta de importación única a esta importación de paquete.",
    previewSourceLabel: "Fuente",
    previewSourceZip: "Paquete ZIP",
    previewCardsLabel: "Tarjetas",
    previewReferencedMediaLabel: "Multimedia referenciada",
    previewPackageMediaLabel: "Archivos multimedia",
    importTagValueLabel: "Etiqueta de importación",
    importTagRequired: "Introduce una etiqueta de importación o desactiva el etiquetado de tarjetas importadas.",
    previewMetadataLabel: "Etiqueta",
    previewMetadataAuthor: "Autor",
    previewMetadataComment: "Comentario",
    previewMetadataCreatedAt: "Creado",
    previewMetadataSourceUrl: "Fuente",
    previewWarningsTitle: "Advertencias",
    previewWarningWithPath: "{{message}} ({{path}})",
    previewTagsTitle: "Etiquetas del paquete",
  ...
  notificationsSettings: {
    ...
    value: "App móvil",
    cardTitle: "Gestiona las notificaciones en la app móvil",
    paragraphOne: "Los ajustes de las notificaciones pertenecen a cada instalación de la app móvil, no a un espacio de trabajo ni a tu cuenta.",
    ...
    paragraphThree: "La app web no envía ni gestiona estas notificaciones, así que no hay controles de notificaciones en esta pantalla.",
  },
  ...
  cardsScreen: {
    ...
    empty: {
      ...
      noMatches: "No hay tarjetas coincidentes. Prueba con otra búsqueda o limpia los filtros.",
    },
    filters: {
      actions: {
        apply: "Aplicar",
  ...
  deckDetail: {
    ...
    empty: {
      allCards: "Aún no has creado ninguna tarjeta.",
      deckCards: "Este mazo aún no tiene tarjetas coincidentes.",
  ...
  tagsScreen: {
    ...
    empty: "Aún no se ha usado ninguna etiqueta.",
    subtitle: "Las etiquetas agrupan tarjetas en todo el espacio de trabajo. Los recuentos por etiqueta pueden solaparse cuando una tarjeta tiene varias etiquetas.",
    title: "Etiquetas",
    totalCards: {
  ...
  agentConnections: {
    ...
    revoke: "Revocar",
    generateTitle: "Crear una nueva conexión de bot",
    labelPlaceholder: "Etiqueta (p. ej., Agente de mi portátil)",
    generate: "Generar clave",
    generateError: "No se pudo generar una clave de API. Inténtalo de nuevo.",
    keyShownOnceTitle: "Tu nueva clave de API",
    keyShownOnceWarning: "Guarda esta clave ahora. Solo se muestra una vez y no se puede recuperar de nuevo. Si la pierdes, revoca esta conexión y crea una nueva.",
    copy: "Copiar",
    copied: "Copiada",
    done: "Listo",
  },
