...
export const zhHansCatalog = {
  ...
  ankiImport: {
    ...
    settingsDescription: "从 Anki 牌组包创建卡片。可将任意笔记类型（包括自定义与 Cloze）的字段映射到正面与背面。",
    settingsValue: "选择文件",
    parsing: "正在读取 .apkg…",
    importing: "正在导入 {{count}} 条笔记…",
    progress: "已导入 {{imported}} / {{total}}",
    success: "已将 {{imported}} 张卡片导入牌组“{{deck}}”。跳过空笔记：{{skippedEmpty}}。未映射：{{skippedUnmapped}}。文件中的 Cloze：{{cloze}}。",
    failed: "无法导入 .apkg 文件。",
    invalidFile: "请选择 .apkg 文件。",
    workspaceUnavailable: "工作区不可用。",
    previewSourceLabel: "文件",
    previewNotesLabel: "笔记",
    previewModelsLabel: "笔记类型",
    mappingHint: "为每种笔记类型选择作为正面与背面的字段。选择会在下次导入时记住。",
    clozeLabel: "Cloze",
    modelNoteCount: "{{count}} 条笔记",
    frontFieldsLabel: "正面字段",
    backFieldsLabel: "背面字段",
    previewSampleLabel: "示例卡片",
    previewFrontLabel: "正面",
    previewBackLabel: "背面",
    previewEmpty: "（空）",
    frontRequired: "请至少选择一个正面字段。",
    confirmImport: "按此映射导入",
    cancelMapping: "取消",
  },
  localBackup: {
    bannerTitle: "备份已就绪",
    ...
    dismissAction: "稍后",
    saved: "已开始下载备份文件。",
    shareOpened: "已打开分享面板。选择“文件”即可保存备份。",
    saveFailed: "无法保存备份文件。",
    settingsTitle: "备份到文件",
    settingsDescription: "将卡片、牌组和复习记录导出为此设备上的 JSON 文件。",
    settingsValue: "保存",
    lastSavedNever: "尚未创建文件备份",
    lastSavedPrefix: "上次保存",
  },
  settingsTest: {
    title: "测试",
    ...
    localSyncDiagnostics: {
      title: "本地同步诊断",
      description: "检查 IndexedDB 中的本地卡片和媒体同步状态。",
      value: "只读",
      screenTitle: "本地同步诊断",
      screenSubtitle: "此浏览器的只读本地同步状态。",
      refresh: "刷新",
      refreshing: "正在刷新...",
      copy: "复制诊断",
      copied: "已复制诊断。",
      ...
      noWorkspace: "没有可用的活动工作区。",
      unavailable: "-",
      sections: {
        cardsSync: "卡片同步",
        managedMediaSync: "托管媒体同步",
        problemRecords: "问题记录",
      },
      fields: {
        workspaceId: "工作区 ID",
        installationId: "安装 ID",
        cloudState: "云状态",
        localActiveCards: "本地活动卡片",
        localDeletedCards: "本地已删除卡片",
        pendingCardOperations: "待处理卡片操作",
        failedCardOperations: "失败卡片操作",
        oldestPendingCardOperation: "最早待处理卡片操作",
        latestCardSyncSuccess: "最近卡片同步成功",
        hotStateHydrated: "热状态已加载",
        hotCursor: "热游标",
        reviewCursor: "复习游标",
        latestSyncError: "最近同步错误",
        localActiveMediaAssets: "本地活动媒体资产",
        deletedMediaAssets: "已删除媒体资产",
        localMediaBlobs: "本地媒体 Blob",
        localMediaBytes: "本地媒体字节",
        referencedMediaInCards: "卡片中引用的媒体",
        referencesMissingLocalAsset: "缺少本地资产的引用",
        assetsMissingLocalBlob: "缺少本地 Blob 的资产",
        pendingMediaUploads: "待上传媒体",
        failedMediaUploads: "上传失败媒体",
        pendingMediaDownloads: "待下载媒体",
        failedMediaDownloads: "下载失败媒体",
        oldestPendingMediaTransfer: "最早待处理媒体传输",
        latestMediaUploadSuccess: "最近媒体上传成功",
        latestMediaDownloadCacheSuccess: "最近媒体下载/缓存成功",
        latestMediaTransferError: "最近媒体传输错误",
      },
      problem: {
        failedCardOutboxOperations: "失败的卡片 outbox 操作",
        failedMediaTransfers: "失败的媒体传输",
        missingMediaReferences: "缺失媒体引用",
        assetsMissingLocalBlob: "缺少本地 Blob 的资产",
        empty: "无",
        cardId: "卡片 ID",
  ...
  settingsWorkspace: {
    ...
    import: {
      title: "导入",
      description: "从可移植的 flashcards.zip 包添加卡片。",
      value: "flashcards.zip",
    },
    resetProgress: {
      title: "重置学习进度",
  ...
  workspaceExport: {
    title: "导出",
    subtitle: "下载此工作区的可移植包。",
    workspaceUnavailable: "工作区不可用",
    packageTitle: "flashcards.zip",
    packageDescription: "下载前预览活动卡片、元数据、标签和引用的媒体。",
    packageExportSuccess: "已开始下载 flashcards.zip。",
    packageExporting: "正在下载...",
    packagePreviewing: "正在预览...",
    packageExportPreviewButton: "预览导出",
    packageExportConfirmButton: "下载 flashcards.zip",
    packageExportPreviewRequired: "下载前请先预览此导出。",
    previewCardsLabel: "卡片",
    previewReferencedMediaLabel: "引用的媒体",
    previewMetadataLabel: "标签",
    previewMetadataAuthor: "作者",
    previewMetadataComment: "备注",
    previewMetadataCreatedAt: "创建时间",
    previewMetadataSourceUrl: "来源",
    exportPreviewReferencedMediaBytesLabel: "媒体大小",
    cardSelectionTitle: "要导出的卡片",
    cardSelectionDescription: "选择全部卡片，或按标签选择卡片。",
    cardSelectionAllCardsLabel: "全部卡片",
    cardSelectionTagLabel: "带有 {{tag}} 的卡片（{{count}} 张）",
    includedTagsTitle: "包中包含的标签",
    includedTagsDescription: "这些标签会保留在导出的卡片上。导入标签会自动省略。",
    includedTagLabel: "包含 {{tag}}（{{count}} 张卡片）",
  },
  workspaceImport: {
    title: "导入",
    subtitle: "从可移植包添加卡片。",
    ...
    importTagDescription: "为这次包导入添加一个唯一导入标签。",
    previewSourceLabel: "来源",
    previewSourceZip: "ZIP 包",
    previewCardsLabel: "卡片",
    previewReferencedMediaLabel: "引用的媒体",
    previewPackageMediaLabel: "包内媒体文件",
    importTagValueLabel: "导入标签",
    importTagRequired: "请输入导入标签，或关闭为导入卡片打标签。",
    previewMetadataLabel: "标签",
    previewMetadataAuthor: "作者",
    previewMetadataComment: "备注",
    previewMetadataCreatedAt: "创建时间",
