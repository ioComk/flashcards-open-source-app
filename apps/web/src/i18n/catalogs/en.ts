const enCatalog = {
  ...
  ankiImport: {
    ...
    settingsDescription: "Create cards from an Anki deck package. Map any note type fields (including custom and cloze) to front and back.",
    settingsValue: "Choose file",
    parsing: "Reading .apkg…",
    importing: "Importing {{count}} notes…",
    progress: "Imported {{imported}} / {{total}}",
    success: "Imported {{imported}} cards into deck “{{deck}}”. Skipped empty: {{skippedEmpty}}. Skipped unmapped: {{skippedUnmapped}}. Cloze notes in file: {{cloze}}.",
    failed: "Could not import the .apkg file.",
    invalidFile: "Please choose an .apkg file.",
    workspaceUnavailable: "Workspace is unavailable.",
    previewSourceLabel: "File",
    previewNotesLabel: "Notes",
    previewModelsLabel: "Note types",
    mappingHint: "Choose which fields become the card front and back for each note type. Selections are remembered for the next import.",
    clozeLabel: "Cloze",
    modelNoteCount: "{{count}} notes",
    frontFieldsLabel: "Front fields",
    backFieldsLabel: "Back fields",
    previewSampleLabel: "Sample card",
    previewFrontLabel: "Front",
    previewBackLabel: "Back",
    previewEmpty: "(empty)",
    frontRequired: "Select at least one front field.",
    confirmImport: "Import with this mapping",
    cancelMapping: "Cancel",
  },
  localBackup: {
    ...
    saveAction: "Save backup file",
    dismissAction: "Later",
    saved: "Backup file download started.",
    shareOpened: "Share sheet opened. Choose Files to keep the backup.",
    saveFailed: "Could not save the backup file.",
    settingsTitle: "Backup to file",
    settingsDescription: "Export cards, decks, and review history as a JSON file on this device.",
    settingsValue: "Save",
    lastSavedNever: "No file backup yet",
