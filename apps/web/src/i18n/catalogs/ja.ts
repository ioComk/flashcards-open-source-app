...
export const jaCatalog = {
  ...
  ankiImport: {
    ...
    settingsDescription: "Ankiデッキパッケージからカードを作成します。カスタムノートタイプや Cloze も含め、フィールドを表・裏に割り当てできます。",
    settingsValue: "ファイルを選択",
    parsing: ".apkg を読み込み中…",
    importing: "{{count}} 件のノートをインポート中…",
    progress: "{{imported}} / {{total}} 件をインポート済み",
    success: "デッキ「{{deck}}」に {{imported}} 枚のカードをインポートしました。スキップ（空）: {{skippedEmpty}}。スキップ（未割当）: {{skippedUnmapped}}。ファイル内の Cloze: {{cloze}}。",
    failed: ".apkg をインポートできませんでした。",
    invalidFile: ".apkg ファイルを選んでください。",
    workspaceUnavailable: "ワークスペースを利用できません。",
    previewSourceLabel: "ファイル",
    previewNotesLabel: "ノート",
    previewModelsLabel: "ノートタイプ",
    mappingHint: "ノートタイプごとに、表・裏にするフィールドを選んでください。選択内容は次回のインポートでも記憶されます。",
    clozeLabel: "Cloze",
    modelNoteCount: "{{count}} 件",
    frontFieldsLabel: "表面のフィールド",
    backFieldsLabel: "裏面のフィールド",
    previewSampleLabel: "プレビュー",
    previewFrontLabel: "表",
    previewBackLabel: "裏",
    previewEmpty: "（空）",
    frontRequired: "表面のフィールドを1つ以上選んでください。",
    confirmImport: "この割り当てでインポート",
    cancelMapping: "キャンセル",
  },
  localBackup: {
    bannerTitle: "バックアップの準備ができました",
    bannerBody: "JSONバックアップを「ファイル」やダウンロードへ保存できます。iPhoneでは無操作での自動保存ができないため、タップが必要です。",
    saveAction: "バックアップを保存",
    dismissAction: "あとで",
    saved: "バックアップのダウンロードを開始しました。",
    shareOpened: "共有シートを開きました。「ファイル」を選ぶと保存できます。",
    saveFailed: "バックアップを保存できませんでした。",
    settingsTitle: "ファイルにバックアップ",
    settingsDescription: "カード・デッキ・復習履歴をこの端末のJSONファイルとして書き出します。",
    settingsValue: "保存",
    lastSavedNever: "まだファイルバックアップはありません",
    lastSavedPrefix: "前回の保存",
  },
  settingsTest: {
    title: "テスト",
