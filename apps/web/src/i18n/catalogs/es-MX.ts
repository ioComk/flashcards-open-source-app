...
const esMxCatalog: TranslationCatalog = {
  ...
  loading: {
    ...
    importSettings: "Cargando la configuración de importación...",
  ...
  progressScreen: {
    ...
    leaderboard: {
      title: "Tabla de posiciones por calificaciones",
      loading: "Cargando la tabla de posiciones por calificaciones...",
      infoToggleLabel: "Acerca de la tabla por calificaciones",
      info: "Los repasos calificados como Difícil, Bien o Fácil cuentan para tu posición. Los repasos con Otra vez no cuentan.",
      periodsLabel: "Periodo de la tabla por calificaciones",
      periods: {
        last24Hours: "24 h",
        last3Days: "3 d",
        last7Days: "7 d",
      ...
      guestBody: "Inicia sesión para ver cómo se ubican tus calificaciones de repaso frente a otros estudiantes.",
      ...
      invite: {
        ...
        creating: "Creando...",
        readyBody: "Envía este enlace a tu amigo. Podrá abrirlo, iniciar sesión o registrarse, y se verán en la app. Vence el {{expiresAt}}.",
      ...
      profile: {
        ...
        linkedAccountRequired: "Inicia sesión para ver perfiles de la tabla.",
        participationDisabled: "Este perfil está oculto mientras la participación en la tabla está desactivada.",
        unavailable: "Este perfil de la tabla no está disponible por ahora.",
        errorBody: "No se pudo cargar este perfil. Revisa tu conexión e inténtalo de nuevo.",
      },
    },
    streakLeaderboard: {
      title: "Tabla de posiciones por racha",
      loading: "Cargando la tabla de posiciones por racha...",
      infoToggleLabel: "Acerca de la tabla por racha",
      info: "Los días de tu racha actual determinan tu posición. Un día de racha es cualquier día local con al menos un repaso de tarjeta calificado como Otra vez, Difícil, Bien o Fácil. Cuando la instantánea pública aún no está disponible, se muestra tu racha actual local.",
      updatedAt: "Actualizado hace {{duration}}",
      guestBody: "Inicia sesión para comparar tu racha actual con otros estudiantes.",
      participationDisabledBody: "Las posiciones por racha están ocultas mientras la participación en la tabla está desactivada. Actívala de nuevo para ver a otros estudiantes y tu posición.",
      offlineEmpty: "La tabla por racha no está disponible sin conexión. Conéctate para ver las posiciones.",
      unavailable: "La tabla por racha no está disponible por ahora. Vuelve más tarde.",
      dayLabels: {
        one: "día",
        other: "días",
      },
  ...
  friendInvite: {
    ...
    signInBody: "Flashcards es una app de estudio para recordar con tarjetas. Esta invitación te conecta con la persona que la envió, para que puedan verse en estadísticas como la tabla de posiciones. Continúa con tu correo para usar la app y conectarse.",
    ...
    successBody: "Ahora son amigos en Flashcards. Por ahora podrán encontrarse en la tabla de posiciones.",
  ...
  localBackup: {
    bannerTitle: "Respaldo listo",
    bannerBody: "Guarda un respaldo JSON en Archivos o Descargas. El iPhone no puede guardar archivos en silencio; se necesita un toque.",
    saveAction: "Guardar respaldo",
    dismissAction: "Después",
    saved: "Se inició la descarga del respaldo.",
    shareOpened: "Se abrió el menú para compartir. Elige Archivos para guardar el respaldo.",
    saveFailed: "No se pudo guardar el respaldo.",
    settingsTitle: "Respaldo en archivo",
    settingsDescription: "Exporta tarjetas, mazos e historial de repaso como JSON en este dispositivo.",
    settingsValue: "Guardar",
    lastSavedNever: "Aún no hay respaldo en archivo",
    lastSavedPrefix: "Último guardado",
  },
  settingsTest: {
    title: "Prueba",
    ...
    localSyncDiagnostics: {
      ...
      sections: {
        ...
        managedMediaSync: "Sincronización de medios administrados",
  ...
  workspaceExport: {
    ...
    packageExportSuccess: "La descarga de flashcards.zip comenzó.",
  ...
  workspaceImport: {
    ...
    importTagDescription: "Agrega una etiqueta de importación única a esta importación de paquete.",
    ...
    importTagRequired: "Ingresa una etiqueta de importación o desactiva el etiquetado de tarjetas importadas.",
    previewMetadataLabel: "Etiqueta",
    previewMetadataAuthor: "Autor",
    previewMetadataComment: "Comentario",
    previewMetadataCreatedAt: "Creado",
  ...
  agentConnections: {
    ...
    labelPlaceholder: "Etiqueta (p. ej., Agente de mi laptop)",
